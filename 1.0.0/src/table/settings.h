/* $Id: settings.h 19393 2010-03-12 21:12:35Z rubidium $ */
...
static const SettingDescGlobVarList _misc_settings[] = {
	...
	SDTG_CONDLIST("resolution",  SLE_INT, 2, S, 0, _cur_resolution,   "768,1024",    STR_NULL, NULL, 0, SL_MAX_VERSION), // workaround for implicit lengthof() in SDTG_LIST
...
const SettingDesc _settings[] = {
	...
	/* Do not ADD or REMOVE something in this "difficulty.XXX" table or before it. It breaks savegame compatability. */
	 SDT_CONDVAR(GameSettings, difficulty.max_no_competitors,        SLE_UINT8, 97, SL_MAX_VERSION, 0, 0,     2,0,MAX_COMPANIES-1,1,STR_NULL,                                  MaxNoAIsChange),
 ...
 SDT_CONDOMANY(GameSettings, locale.units,                                  SLE_UINT8, 97, SL_MAX_VERSION, N, 0, 1, 2, _locale_units,                       STR_NULL, NULL, NULL),
   ...
   SDT_CONDSTR(GameSettings, locale.digit_decimal_separator,                 SLE_STRQ,126, SL_MAX_VERSION, N, 0, NULL,                                      STR_NULL, NULL),
	...
	SDTC_OMANY(gui.date_format_in_default_names,SLE_UINT8,S,MS, 0, 2, _savegame_date,         STR_CONFIG_SETTING_DATE_FORMAT_IN_SAVE_NAMES,   NULL),
	 ...
	 SDTC_BOOL(gui.left_mouse_btn_scrolling,             S,  0, true,                        STR_CONFIG_SETTING_LEFT_MOUSE_BTN_SCROLLING,    NULL),
	 ...
	 SDTC_BOOL(gui.autosave_on_exit,                     S,  0, true,                        STR_NULL,                                       NULL),
